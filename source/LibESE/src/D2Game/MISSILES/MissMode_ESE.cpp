...
void __stdcall ESE_MISSMODE_FillDamageParams(D2UnitStrc* pMissile, D2UnitStrc* pTarget, ESE_D2DamageStrc* pDamage)
{
    ...
    pDamage->dwPhysDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_MINDAMAGE, STAT_MAXDAMAGE, -1);
    pDamage->dwFireDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_FIREMINDAM, STAT_FIREMAXDAM, STAT_PASSIVE_FIRE_MASTERY);
    pDamage->dwMagDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_MAGICMINDAM, STAT_MAGICMAXDAM, STAT_PASSIVE_MAG_MASTERY);
    pDamage->dwLtngDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_LIGHTMINDAM, STAT_LIGHTMAXDAM, STAT_PASSIVE_LTNG_MASTERY);
    pDamage->dwColdDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_COLDMINDAM, STAT_COLDMAXDAM, STAT_PASSIVE_COLD_MASTERY);
    pDamage->dwColdLen = STATLIST_UnitGetStatValue(pMissile, STAT_COLDLENGTH, 0);
    pDamage->dwPoisDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_POISONMINDAM, STAT_POISONMAXDAM, STAT_PASSIVE_POIS_MASTERY);
    pDamage->dwPoisLen = STATLIST_UnitGetStatValue(pMissile, STAT_POISONLENGTH, 0);

    const int64_t nPoisonCount = STATLIST_UnitGetStatValue(pMissile, STAT_POISON_COUNT, 0);
    if (nPoisonCount > 1)
    {
    ...
    pDamage->dwBurnDamage = ESE_MISSMODE_RollDamageValue(pMissile, STAT_BURNINGMIN, STAT_BURNINGMAX, STAT_PASSIVE_FIRE_MASTERY);
    ...
    if (pTarget)
    {
        int64_t nDamagePercent = STATLIST_UnitGetStatValue(pMissile, STAT_DAMAGEPERCENT, 0);
        ...
        nDamagePercent = std::max(nDamagePercent, -90LL);

        pDamage->dwPhysDamage += (nDamagePercent * pDamage->dwPhysDamage) / 100LL;
    }
...
int64_t __fastcall ESE_MISSMODE_RollDamageValue(D2UnitStrc* pUnit, int32_t nMinDamStat, int32_t nMaxDamStat, int32_t nMasteryStat)
{
    ...
    if (nMasteryStat != -1)
    {
        const int64_t nMastery = STATLIST_UnitGetStatValue(pUnit, nMasteryStat, 0);
        if (nMastery)
        {
            nMinDam += ESE_DATATBLS_ApplyRatio(nMinDam, nMastery, 100);
            nMaxDam += ESE_DATATBLS_ApplyRatio(nMaxDam, nMastery, 100);
        }
    }

    return nMinDam + ESE_ITEMS_RollLimitedRandomNumber(&pUnit->pSeed, nMaxDam - nMinDam);
}
...
int64_t __fastcall ESE_MISSMODE_GetDamageValue(D2GameStrc* pGame, D2UnitStrc* pAttacker, D2UnitStrc* pDefender, ESE_D2DamageStrc* pDamage)
{
    ...
    case ELEMTYPE_NONE:
    {
        pDamage->dwPhysDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_MINDAMAGE, STAT_MAXDAMAGE, -1);

        if (pDefender)
        {
            int64_t nDamagePercent = STATLIST_UnitGetStatValue(pAttacker, STAT_DAMAGEPERCENT, 0);
    ...
    case ELEMTYPE_FIRE:
    {
        pDamage->dwFireDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_FIREMINDAM, STAT_FIREMAXDAM, STAT_PASSIVE_FIRE_MASTERY);
        return pDamage->dwFireDamage;
    }
    case ELEMTYPE_LTNG:
    {
        pDamage->dwLtngDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_LIGHTMINDAM, STAT_LIGHTMAXDAM, STAT_PASSIVE_LTNG_MASTERY);
        return pDamage->dwLtngDamage;
    }
    case ELEMTYPE_MAGIC:
    {
        pDamage->dwMagDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_MAGICMINDAM, STAT_MAGICMAXDAM, STAT_PASSIVE_MAG_MASTERY);
        return pDamage->dwMagDamage;
    }
    case ELEMTYPE_COLD:
    {
        pDamage->dwColdDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_COLDMINDAM, STAT_COLDMAXDAM, STAT_PASSIVE_COLD_MASTERY);
        pDamage->dwColdLen = STATLIST_UnitGetStatValue(pAttacker, STAT_COLDLENGTH, 0);
        return pDamage->dwColdDamage;
    }
    case ELEMTYPE_POIS:
    {
        pDamage->dwPoisDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_POISONMINDAM, STAT_POISONMAXDAM, STAT_PASSIVE_POIS_MASTERY);
        pDamage->dwPoisLen = STATLIST_UnitGetStatValue(pAttacker, STAT_POISONLENGTH, 0);

        const int64_t nPoisonCount = STATLIST_UnitGetStatValue(pAttacker, STAT_POISON_COUNT, 0);
        if (nPoisonCount > 1)
        {
            pDamage->dwPoisLen /= nPoisonCount;
        }
    ...
    case ELEMTYPE_BURN:
    {
        pDamage->dwBurnDamage = ESE_MISSMODE_RollDamageValue(pAttacker, STAT_BURNINGMIN, STAT_BURNINGMAX, STAT_PASSIVE_FIRE_MASTERY);
...
//D2Game.0x6FC56AB0
void __fastcall ESE_MISSMODE_CreateImmolationArrowHitSubmissiles(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t a3, int32_t nMissileId, int32_t nRange)
{
    // TODO: No intercept needed
...
//D2Game.0x6FC56D50
int32_t __fastcall ESE_MISSMODE_HandleMissileCollision(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
        return ESE_MISSMODE_SrvDmgHitHandler(pGame, pMissile, nullptr, 1);
    }
    
    D2MissilesTxt* pMissilesTxtRecord = ESE_SKILLS_GetMissilesTxtRecord(pMissile->dwClassId);
    ...
    for (int32_t i = 0; i < nPathPoints; ++i)
    {
        ...
        if (nCollisionMask)
        {
            ...
            if (nCollisionMask & 4)
            {
                ESE_MISSMODE_SrvDmgHitHandler(pGame, pMissile, nullptr, 1);
                return 2;
            }
        }
    }
...
//D2Game.0x6FC56FA0
D2UnitStrc* __fastcall ESE_MISSMODE_CreatePlagueJavelin_PoisonJavelin_PoisonTrapHitSubmissiles(D2GameStrc* pGame, D2UnitStrc* pOrigin, int32_t nMissileId, int32_t nRange, int32_t nLoops)
{
    // TODO: No intercept needed
...
//D2Game.0x6FC570B0
int32_t __fastcall ESE_MISSMODE_SrvDo02_PlagueJavelin_PoisonJavelin_PoisonTrap(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (pMissile)
    {
...
//D2Game.0x6FC57140
int32_t __fastcall ESE_MISSMODE_SrvDo03_PoisonCloud_Blizzard_ThunderStorm_HandOfGod(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
...
//D2Game.0x6FC571D0
int32_t __fastcall ESE_MISSMODE_SrvDo05_FireWall_ImmolationFire_MeteorFire_MoltenBoulderFirePath(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
    ...
    {
        pMissile->nSeqCurrentFramePrecise = (nCurrentFrame + ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, pMissilesTxtRecord->nSubStop - pMissilesTxtRecord->nSubStart)) << 8;
    }
...
//D2Game.0x6FC573B0
int32_t __fastcall ESE_MISSMODE_SrvDo06_MoltenBoulder_FireWallMaker(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    if (!pOwner || !pMissile)
...
//D2Game.0x6FC57510
int32_t __fastcall ESE_MISSMODE_SrvDo07_GuidedArrow_BoneSpirit(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
...
//D2Game.0x6FC57640
int32_t __fastcall ESE_MISSMODE_SrvDo08_MonBlizzCenter(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
    ...
    ESE_MISSMODE_CreateMissileWithCollisionCheck(pGame, pMissile, nParam + pMissilesTxtRecord->dwParam[0], nFrames, pMissilesTxtRecord->wSubMissile[0], 5);
    return ESE_MISSMODE_HandleMissileCollision(pGame, pMissile);
}

//D2Game.0x6FC576F0
D2UnitStrc* __fastcall ESE_MISSMODE_CreateMissileWithCollisionCheck(D2GameStrc* pGame, D2UnitStrc* pMissile, int32_t nRange, int32_t nFrames, int32_t nMissileId, uint16_t nCollisionMask)
{
    // TODO: No intercept needed
    ...
    missileParams.nX = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2 * nMaxRange) - nMaxRange + CLIENTS_GetUnitX(pMissile);
    missileParams.nY = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2 * nMaxRange) - nMaxRange + CLIENTS_GetUnitY(pMissile);
...
//D2Game.0x6FC57910
int32_t __fastcall ESE_MISSMODE_SrvDo09_BatLightningBolt(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
...
//D2Game.0x6FC57A40
int32_t __fastcall ESE_MISSMODE_SrvDo10_BlizzardCenter(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
    ...
    const int32_t nLevel = MISSILE_GetLevel(pMissile);
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    ESE_MISSMODE_CreateMissileWithCollisionCheck(pGame, pMissile, SKILLS_EvaluateSkillFormula(pOwner, pSkillsTxtRecord->dwCalc[0], nSkillId, nLevel), SKILLS_EvaluateSkillFormula(pOwner, pSkillsTxtRecord->dwCalc[1], nSkillId, nLevel), pMissilesTxtRecord->wSubMissile[0], 5);
    return ESE_MISSMODE_HandleMissileCollision(pGame, pMissile);
}

//D2Game.0x6FC57B60
int32_t __fastcall ESE_MISSMODE_SrvDo11_FingerMageSpider(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
...
//D2Game.0x6FC57DA0
int32_t __fastcall ESE_MISSMODE_SrvDo12_DiabWallMaker(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
...
//D2Game.0x6FC57F00
int32_t __fastcall ESE_MISSMODE_SrvDo13_BoneWallMaker(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
...
//D2Game.0x6FC58140
int32_t __fastcall ESE_MISSMODE_SrvDo14_GrimWard(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    // TODO: No intercept needed
    if (!pMissile)
    {
...
//D2Game.0x6FC581F0
int32_t __fastcall ESE_MISSMODE_SrvDo15_FrozenOrb(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
...
//D2Game.0x6FC58340
int32_t __fastcall ESE_MISSMODE_SrvDo16_FrozenOrbNova(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
//D2Game.0x6FC58480
int32_t __fastcall ESE_MISSMODE_SrvDo17_CairnStones(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    {
        ESE_MISSMODE_CreateMissileWithCollisionCheck(pGame, pMissile, pMissilesTxtRecord->dwParam[2], pMissilesTxtRecord->dwParam[1], pMissilesTxtRecord->wSubMissile[0], 5);
    }
...
//D2Game.0x6FC585E0
int32_t __fastcall ESE_MISSMODE_SrvDo18_TowerChestSpawner(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    if (MISSILE_GetTargetY(pMissile))
    {
        ...
        if (!(nCurrentFrame % nFrames))
        {
            ...
            pCoord.nX += ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2 * nRange + 1) - nRange;
            pCoord.nY += ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2 * nRange + 1) - nRange;
...
//D2Game.0x6FC58860
int32_t __fastcall ESE_MISSMODE_SrvDo20_BladeCreeper(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    ...
    ESE_MISSMODE_HandleMissileCollision(pGame, pMissile);
    return 1;
}

//D2Game.0x6FC58940
int32_t __fastcall ESE_MISSMODE_SrvDo21_Distraction(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
//D2Game.0x6FC58B00
int32_t __fastcall ESE_MISSMODE_SrvDo22_LightningTrailingJavelin(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
//D2Game.0x6FC58CC0
int32_t __fastcall ESE_MISSMODE_SrvDo23_24_SuccFireBall_FirestormMaker(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
int32_t __fastcall ESE_MISSMODE_SrvDo25_EruptionCenter(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    ...
    ESE_MISSMODE_CreateMissileWithCollisionCheck(pGame, pMissile, nRange, nFrames, pMissilesTxtRecord->wSubMissile[0], 0x45);
...
int32_t __fastcall ESE_MISSMODE_SrvDo27_Tornado(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    ...
    if (!(nRemainingFrames % nParam0))
    {
        ...
        ESE_MISSMODE_FillDamageParams(pMissile, 0, &damage);
...
int32_t __fastcall ESE_MISSMODE_SrvDo28_Volcano(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    ...
    if (pOwner)
    {
        ...
        if (nRemainingFrames > pMissilesTxtRecord->dwParam[2] && nRemainingFrames < pMissilesTxtRecord->dwParam[3] && !(nRemainingFrames % nFrames))
        {
            ...
            const int32_t nOffsetX = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2LL * nAuraRange + 1) - nAuraRange;
            const int32_t nOffsetY = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, 2LL * nAuraRange + 1) - nAuraRange;
...
//D2Game.0x6FC594B0
int32_t __fastcall ESE_MISSMODE_SrvDo29_RecyclerDelay(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    if (pOwner && !SUNIT_IsDead(pOwner))
    {
        ...
        {
            const int64_t nHitpoints = STATLIST_UnitGetStatValue(pOwner, STAT_HITPOINTS, 0) >> 8;
            const int64_t nMaxHp = STATLIST_GetMaxLifeFromUnit(pOwner) >> 8;
...
//D2Game.0x6FC596C0
int32_t __fastcall ESE_MISSMODE_SrvDo33_VineRecyclerDelay(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    if (pOwner && !SUNIT_IsDead(pOwner))
    {
        if (MISSILE_GetRemainingFrames(pMissile) == pMissilesTxtRecord->dwParam[0])
        {
            const int64_t nMana = STATLIST_UnitGetStatValue(pOwner, STAT_MANA, 0) >> 8;
            const int64_t nMaxMana = STATLIST_GetMaxManaFromUnit(pOwner) >> 8;
            if (nMana < nMaxMana)
            {
                int64_t percent = SKILLS_EvaluateSkillFormula(pOwner, pSkillsTxtRecord->dwCalc[0], nSkillId, MISSILE_GetLevel(pMissile));
                int64_t additionalMana = ESE_DATATBLS_ApplyRatio(nMaxMana, percent, 100);

                const int64_t nNewMana = std::min(additionalMana + nMana, nMaxMana);

                // TODO: Clamp all of the STATLIST_SetUnitStat to 32 from 64 where necessary. check all the other calls to it
                STATLIST_SetUnitStat(pOwner, STAT_MANA, Clamp64To32(nNewMana << 8), 0);
...
//D2Game.0x6FC598D0
int32_t __fastcall ESE_MISSMODE_SrvDo30_RabiesPlague(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    if (!(MISSILE_GetRemainingFrames(pMissile) % nParam))
    {
        ...
        missileParams.nTargetX = ESE_ITEMS_RollLimitedRandomNumber(&pUnit->pSeed, nRange) - pMissilesTxtRecord->dwParam[1];
        missileParams.nTargetY = ESE_ITEMS_RollLimitedRandomNumber(&pUnit->pSeed, nRange) - pMissilesTxtRecord->dwParam[1];

        D2UnitStrc* pSubMissile = ESE_MISSILES_CreateMissileFromParams(pGame, &missileParams);
...
//D2Game.0x6FC59B90
int32_t __fastcall ESE_MISSMODE_SrvDo31_WakeOfDestructionMaker_BaalColdMaker(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
    ...
    if (!pOwner)
    {
        ESE_MISSMODE_SrvDmgHitHandler(pGame, pMissile, nullptr, 0);
        return 2;
    }
...
//D2Game.0x6FC59CB0
int32_t __fastcall ESE_MISSMODE_SrvDo32_TigerFury(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
int32_t __fastcall ESE_MISSMODE_SrvDo34_BaalTauntControl(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    ...
    if (nRemainingFrames >= pMissilesTxtRecord->dwParam[0])
    {
        ...
        const int32_t nIndex = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, nCounter);
        if (!(nRemainingFrames % pMissilesTxtRecord->dwParam[nIndex + 1]))
        {
            ...
            if (pSubMissile)
            {
                ESE_MISSMODE_SrvDmgHitHandler(pGame, pSubMissile, nullptr, 1);
            }
        }
    }
...
int32_t __fastcall ESE_MISSMODE_SrvHit02_PlagueJavelin_PoisonPotion(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    ...
    const int32_t nSkillId = MISSILE_GetSkill(pMissile);
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    ESE_MISSMODE_CreatePoisonCloudHitSubmissiles(pGame, pOwner, pOrigin, pMissilesTxtRecord->wHitSubMissile[0], nSkillId, nLevel, pMissilesTxtRecord->dwHitPar[0], pMissilesTxtRecord->dwHitPar[1], pMissilesTxtRecord->dwHitPar[2]);
    return 3;
}

//D2Game.0x6FC5A580
int32_t __fastcall ESE_MISSMODE_SrvHit44_ExplodingJavelin(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5A740
int32_t __fastcall ESE_MISSMODE_SrvHit03_ExplosivePotion_BombOnGround(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pUnit)
    {
        return ESE_MISSMODE_SrvHit44_ExplodingJavelin(pGame, pMissile, 0);
    }
...
//D2Game.0x6FC5A760
int32_t __fastcall ESE_MISSMODE_SrvHit07_HolyBolt_FistOfTheHeavenBolt(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    if (nRand <= 0)
    {
        nRand = ESE_MISSMODE_RollDamageValue(pMissile, STAT_MINDAMAGE, STAT_MAXDAMAGE, -1);
    }

    const int64_t nMaxHp = STATLIST_GetMaxLifeFromUnit(pUnit);
    const int64_t nNewHp = std::min(nRand + (int64_t)STATLIST_UnitGetStatValue(pUnit, STAT_HITPOINTS, 0), nMaxHp);
...
//D2Game.0x6FC5A9B0
int32_t __fastcall ESE_MISSMODE_SrvHit08_Blaze(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pUnit)
    {
        return 2;
...
//D2Game.0x6FC5AA00
int32_t __fastcall ESE_MISSMODE_SrvHit06_Unused(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5AB00
int32_t __fastcall ESE_MISSMODE_SrvHit09_ImmolationArrow(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5AD40
int32_t __fastcall ESE_MISSMODE_SrvHit10_GuidedArrow_BoneSpirit(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
...
//D2Game.0x6FC5B020
int32_t __fastcall ESE_MISSMODE_SrvHit12_ChainLightning_LightningStrike(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5B280
int32_t __fastcall ESE_MISSMODE_SrvHit13_GlacialSpike_HellMeteorDown(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    int64_t nLength = pMissilesTxtRecord->dwHitPar[1];
    if (nLength <= 0)
    {
...
//D2Game.0x6FC5B4E0
int32_t __fastcall ESE_MISSMODE_SrvHit04_ExplodingArrow_FreezingArrow_RoyalStrikeMeteorCenter(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    for (int32_t i = 0; i < 4; ++i)
    {
        if (pMissilesTxtRecord->wHitSubMissile[i] > 0)
        {
            ...
            D2UnitStrc* pHitSubMissile = ESE_MISSILES_CreateMissileFromParams(pGame, &missileParams);
            if (pHitSubMissile && pMissilesTxtRecord->dwHitPar[0] > 0)
            {
                ESE_MISSMODE_SrvDmgHitHandler(pGame, pHitSubMissile, pUnit, 1);
            }
        }
    }
...
//D2Game.0x6FC5B5C0
int32_t __fastcall ESE_MISSMODE_SrvHit11_Unused(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5B6A0
int32_t __fastcall ESE_MISSMODE_SrvHit14_MeteorCenter_CatapultMeteor_RoyalStrikeMeteor(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    if (nHitSubMissile >= 0)
    {
        ...
        ESE_MISSMODE_CreateMeteor_MoltenBoulderSubmissiles(pGame, pMissile, nHitSubMissile, nMissileRange, nParam);
    }
...
//D2Game.0x6FC5B910
void __fastcall ESE_MISSMODE_CreateMeteor_MoltenBoulderSubmissiles(D2GameStrc* pGame, D2UnitStrc* pMissile, int32_t nMissileId, int32_t nRange, int32_t nStep)
{
    if (nMissileId < 0)
    {
        return;
...
//D2Game.0x6FC5BA50
int32_t __fastcall ESE_MISSMODE_SrvHit15_SpiderGooLay(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5BB80
int32_t __fastcall ESE_MISSMODE_SrvHit16_SpiderGoo_VinesTrail_VinesWither(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    const int32_t nSkillId = MISSILE_GetSkill(pMissile);
    const int32_t nLevel = MISSILE_GetLevel(pMissile);
    D2SkillsTxt* pSkillsTxtRecord = ESE_SKILLS_GetSkillsTxtRecord(nSkillId);
...
//D2Game.0x6FC5BD30
int32_t __fastcall ESE_MISSMODE_SrvHit17_Howl(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    // TODO: v13, v15
...
//D2Game.0x6FC5BED0
int32_t __fastcall ESE_MISSMODE_SrvHit18_Shout_BattleCommand_BattleOrders(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    if (!pOwner)
    {
    ...
    {
        ESE_SKILLS_ApplyWarcryStats(pGame, pUnit, pOwner, MISSILE_GetSkill(pMissile), MISSILE_GetLevel(pMissile));
    }
...
//D2Game.0x6FC5BF30
int32_t __fastcall ESE_MISSMODE_SrvHit19_FingerMageSpider(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    const int32_t nSkillId = MISSILE_GetSkill(pMissile);
    const int32_t nLevel = MISSILE_GetLevel(pMissile);
    D2SkillsTxt* pSkillsTxtRecord = ESE_SKILLS_GetSkillsTxtRecord(nSkillId);
...
//D2Game.0x6FC5C0D0
int32_t __fastcall ESE_MISSMODE_SrvHit20_LightningFury(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5C2D0
int32_t __fastcall ESE_MISSMODE_LightningFury_AuraCallback(D2AuraCallbackStrc* pAuraCallback, D2UnitStrc* pTarget)
{
    ...
    missileParams.nTargetX = CLIENTS_GetUnitX(pTarget);
    missileParams.nTargetY = CLIENTS_GetUnitY(pTarget);
    ESE_MISSILES_CreateMissileFromParams(pAuraCallback->pGame, &missileParams);

    return 1;
}

//D2Game.0x6FC5C3A0
int32_t __fastcall ESE_MISSMODE_SrvHit21_BattleCry(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    if (!pOwner || !pUnit)
    {
...
//D2Game.0x6FC5C4D0
int32_t __fastcall ESE_MISSMODE_SrvHit22_FistOfTheHeavensDelay(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    ESE_D2DamageStrc damage = {};
    ESE_MISSMODE_FillDamageParams(pMissile, pTarget, &damage);
    ESE_MISSMODE_SetDamageFlags(pGame, pMissile, pTarget, &damage);
...
//D2Game.0x6FC5C790
int32_t __fastcall ESE_MISSMODE_FistOfTheHeavensDelay_AuraCallback(D2AuraCallbackStrc* pAuraCallback, D2UnitStrc* pTarget)
{
    D2HitFunc22ParamStrc* pParams = (D2HitFunc22ParamStrc*)pAuraCallback->pArgs;
...
//D2Game.0x6FC5C860
int32_t __fastcall ESE_MISSMODE_CreatePantherPotGreenSubmissiles(D2GameStrc* pGame, D2UnitStrc* pOwner, D2UnitStrc* pOrigin, int32_t nMissileId, int32_t nSkillId, int32_t nSkillLevel, int32_t nStep)
{
    D2MissilesTxt* pMissilesTxtRecord = ESE_SKILLS_GetMissilesTxtRecord(nMissileId);
    if (!pMissilesTxtRecord)
    {
...
//D2Game.0x6FC5C990
int32_t __fastcall ESE_MISSMODE_SrvHit25_PantherPotGreen(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    ESE_MISSMODE_CreatePantherPotGreenSubmissiles(pGame, pOwner, pOrigin, pMissilesTxtRecord->wHitSubMissile[0], MISSILE_GetSkill(pMissile), MISSILE_GetLevel(pMissile), nHitPar);
    return 3;
}

//D2Game.0x6FC5CA50
int32_t __fastcall ESE_MISSMODE_SrvHit26_GrimWardStart(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5CBE0
int32_t __fastcall ESE_MISSMODE_SrvHit27_GrimWard(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    return 1;
}

//D2Game.0x6FC5CBF0
int32_t __fastcall ESE_MISSMODE_SrvHit28_GrimWardScare(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    const int32_t nSkillId = MISSILE_GetSkill(pMissile);
    D2SkillsTxt* pSkillsTxtRecord = ESE_SKILLS_GetSkillsTxtRecord(nSkillId);
...
//D2Game.0x6FC5CE10
int32_t __fastcall ESE_MISSMODE_SrvHit29_FrozenOrb(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5CF50
int32_t __fastcall ESE_MISSMODE_SrvHit05_Unused(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5D070
int32_t __fastcall ESE_MISSMODE_SrvHit31_FireHead(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    ESE_D2DamageStrc damage = {};
    const int64_t nHeal = std::max(ESE_MISSMODE_GetDamageValue(pGame, pMissile, pUnit, &damage), 0LL);
    const int64_t nMaxHp = STATLIST_GetMaxLifeFromUnit(pOwner);
    const int64_t nNewHp = std::min(nHeal + (int64_t)STATLIST_UnitGetStatValue(pOwner, STAT_HITPOINTS, 0), nMaxHp);
...
//D2Game.0x6FC5D160
int32_t __fastcall ESE_MISSMODE_SrvHit32_CairnStones(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 0;
...
//D2Game.0x6FC5D270
int32_t __fastcall ESE_MISSMODE_SrvHit33_TowerChestSpawner(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pUnit)
    {
        D2ActiveRoomStrc* pRoom = UNITS_GetRoom(pMissile);
...
//D2Game.0x6FC5D290
int32_t __fastcall ESE_MISSMODE_SrvHit35_OrbMist(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (pUnit)
    {
        return 0;
...
//D2Game.0x6FC5D320
int32_t __fastcall ESE_MISSMODE_SrvHit36_MissileInAir(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5D430
int32_t __fastcall ESE_MISSMODE_SrvHit37_BladeCreeper(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (pUnit)
    {
        return 2;
...
//D2Game.0x6FC5D440
void __fastcall ESE_MISSMODE_CatapultChargedBall_LightningTrailingJavelin_SubmissileInitFunc(D2UnitStrc* pMissile, int32_t nUnused)
{
    if (!pMissile)
    {
        return;
...
//D2Game.0x6FC5D490
int32_t __fastcall ESE_MISSMODE_SrvHit38_CatapultChargedBall(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5D620
int32_t __fastcall ESE_MISSMODE_SrvHit39_ImpSpawnMonsters(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
...
//D2Game.0x6FC5D6A0
int32_t __fastcall ESE_MISSMODE_SrvHit40_CatapultSpikeBall(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    ESE_sub_6FCF8330(pGame, pMissile, pOwner, pMissilesTxtRecord->wHitSubMissile[0], nCalc, nCalc / 4, nSkillId, nLevel);
    return 1;
}

//D2Game.0x6FC5D7C0
int32_t __fastcall ESE_MISSMODE_SrvHit43_HealingVortex(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    const int64_t nMinDamage = ESE_SKILLS_GetMinPhysDamage(pOwner, nSkillId, nLevel, 1);
    const int64_t nMaxDamage = ESE_SKILLS_GetMaxPhysDamage(pOwner, nSkillId, nLevel, 1);
    const int64_t nDamage = ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, nMaxDamage - nMinDamage) + nMinDamage;
    ...
    const int64_t nNewHp = std::min(nDamage + nHitpoints, nMaxHp);
    STATLIST_SetUnitStat(pUnit, STAT_HITPOINTS, Clamp64To32(nNewHp), 0);
...
//D2Game.0x6FC5D950
int32_t __fastcall ESE_MISSMODE_SrvHit45_LightningTrailingJavelin(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5DA80
int32_t __fastcall ESE_MISSMODE_SrvHit47_MoltenBoulder(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    const int32_t nParam = std::max(pMissilesTxtRecord->dwHitPar[1], 1u);
    ESE_MISSMODE_CreateMeteor_MoltenBoulderSubmissiles(pGame, pMissile, pMissilesTxtRecord->wHitSubMissile[0], nRange, nParam);
    return nResult;
}

//D2Game.0x6FC5DD10
int32_t __fastcall ESE_MISSMODE_SrvHit48_MoltenBoulderEmerge(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5DE50
int32_t __fastcall ESE_MISSMODE_SrvHit50_PlagueVinesTrail(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5DED0
int32_t __fastcall ESE_MISSMODE_SrvHit51_VolcanoDebris(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5DFC0
int32_t __fastcall ESE_MISSMODE_SrvHit52_BladeFury(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5E0D0
int32_t __fastcall ESE_MISSMODE_SrvHit53_RabiesContagion(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
    if (pOwner && pUnit)
    {
        ...
        if (nFrame >= 10 && nFrame <= ESE_SKILLS_GetElementalLength(pOwner, nSkillId, nLevel, 1))
        {
...
//D2Game.0x6FC5E160
int32_t __fastcall ESE_MISSMODE_SrvHit54_BaalSpawnMonsters(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pUnit)
    {
        D2UnitStrc* pOwner = SUNIT_GetOwner(pGame, pMissile);
...
//D2Game.0x6FC5E220
int32_t __fastcall ESE_MISSMODE_SrvHit55_Baalnferno(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    ...
    const int64_t nCurrentMana = STATLIST_UnitGetStatValue(pUnit, STAT_MANA, 0);
    if (nCurrentMana <= 0)
    {
        return 1;
    }

    const int64_t nPercentage = std::clamp<int64_t>(pMissilesTxtRecord->dwHitPar[0], 1, 100);
    const int64_t nLostMana = std::clamp<int64_t>(ESE_DATATBLS_ApplyRatio(nCurrentMana, nPercentage, 100), 1, nCurrentMana);
    STATLIST_SetUnitStat(pUnit, STAT_MANA, Clamp64To32(nCurrentMana - nLostMana), 0);
    return 2;
}

//D2Game.0x6FC5E370
int32_t __fastcall ESE_MISSMODE_SrvHit56_ArmageddonControl(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
...
//D2Game.0x6FC5E530
int32_t __fastcall ESE_MISSMODE_SrvHit58_BaalTauntLightningControl(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    missileParams.nTargetX = CLIENTS_GetUnitX(pMissile) + ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, nRange) - nParam;
    missileParams.nTargetY = CLIENTS_GetUnitY(pMissile) + ESE_ITEMS_RollLimitedRandomNumber(&pMissile->pSeed, nRange) - nParam;
...
//D2Game.0x6FC5E760
int32_t __fastcall ESE_MISSMODE_SrvHit59_BaalTauntPoisonControl(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pMissile)
    {
        return 1;
    ...
    const int32_t nHitPar = std::max(pMissilesTxtRecord->dwHitPar[0], 1u);
    ESE_MISSMODE_CreatePoisonCloudHitSubmissiles(pGame, pOwner, pMissile, pMissilesTxtRecord->wHitSubMissile[0], MISSILE_GetSkill(pMissile), MISSILE_GetLevel(pMissile), nHitPar, 2, 0);
    return 1;
}
...
void __fastcall ESE_MISSMODE_SrvDmg01_FireArrow_MagicArrow_ColdArrow(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    const int64_t nDamageReduction = std::min(ESE_DATATBLS_ApplyRatio(pDamage->dwPhysDamage, nPercentage, 100), pDamage->dwPhysDamage);

    pDamage->dwPhysDamage -= nDamageReduction;
    ESE_MISSMODE_AddDamageValue(pGame, pMissile, pUnit, pDamage, nDamageReduction);
}
...
void __fastcall ESE_MISSMODE_SrvDmg12_LightningJavelin(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    const int64_t nDamageBonus = std::min(ESE_DATATBLS_ApplyRatio(pDamage->dwPhysDamage, nPercentage, 100), pDamage->dwPhysDamage);
    const int64_t nFinalDamage = ESE_MISSMODE_GetDamageValue(pGame, pMissile, pUnit, pDamage) + nDamageBonus;
    ESE_MISSMODE_ResetDamageParams(pGame, pMissile, pDamage);
    ESE_MISSMODE_AddDamageValue(pGame, pMissile, pUnit, pDamage, nFinalDamage);
}
...
void __fastcall ESE_MISSMODE_SrvDmg02_IceArrow_RoyalStrikeChaos(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    if (pMissilesTxtRecord)
    {
        const int64_t nPercentage = std::max(pMissilesTxtRecord->dwDmgParam[0], 0);
        pDamage->dwFrzLen = ESE_DATATBLS_ApplyRatio(STATLIST_UnitGetStatValue(pMissile, STAT_COLDLENGTH, 0), nPercentage, 100);
        pDamage->dwColdLen = 0;
    }
}
...
{
    if (pMissile && ESE_SKILLS_GetMissilesTxtRecord(pMissile->dwClassId))
    {
        pDamage->dwFrzLen = pDamage->dwColdLen;
    }
}
...
void __fastcall ESE_MISSMODE_SrvDmg05_BlessedHammer(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    const int64_t nBaseDamage = ESE_MISSMODE_GetDamageValue(pGame, pMissile, pUnit, pDamage);
    if (pMissilesTxtRecord->dwDmgParam[0] > 0 && MONSTERS_IsUndead(pUnit))
    {
        ESE_MISSMODE_AddDamageValue(pGame, pMissile, pUnit, pDamage, ESE_DATATBLS_ApplyRatio(nBaseDamage, pMissilesTxtRecord->dwDmgParam[0], 100));
    }

    if (pMissilesTxtRecord->dwDmgParam[1] > 0 && MONSTERS_IsDemon(pUnit))
    {
        ESE_MISSMODE_AddDamageValue(pGame, pMissile, pUnit, pDamage, ESE_DATATBLS_ApplyRatio(nBaseDamage, pMissilesTxtRecord->dwDmgParam[1], 100));
    }
}
...
void __fastcall ESE_MISSMODE_SrvDmg07_Warcry_ShockWave(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    else
    {
        ...
        {
            pDamage->dwStunLen = (int64_t)pSkillsTxtRecord->dwParam[0] + ((int64_t)nLevel - 1) * (int64_t)pSkillsTxtRecord->dwParam[1];
        }
        else
        {
            pDamage->dwStunLen = 0;
...
void __fastcall ESE_MISSMODE_SrvDmg11_RabiesContagion(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    ...
    if (pOwner && pUnit)
    {
        const int32_t nSkillId = MISSILE_GetSkill(pMissile);
        const int32_t nLevel = MISSILE_GetLevel(pMissile);
        const int64_t nPoisonLength = (int64_t)MISSILE_GetTargetX(pMissile) - (int64_t)pGame->dwGameFrame;
        if (nPoisonLength >= 10 && nPoisonLength <= ESE_SKILLS_GetElementalLength(pOwner, nSkillId, nLevel, 1))
        {
...
void __fastcall ESE_MISSMODE_SrvDmg13_BlessedHammerEx(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, ESE_D2DamageStrc* pDamage)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER)
    {
        ...
        if (pOwner)
        {
            pDamage->dwPhysDamage += (pDamage->dwPhysDamage * (int64_t)STATLIST_UnitGetStatValue(pOwner, STAT_DAMAGEPERCENT, 0)) / 100LL;
        }

        ESE_MISSMODE_SrvDmg05_BlessedHammer(pGame, pMissile, pUnit, pDamage);
    }
}
...
void __fastcall ESE_MISSMODE_SetDamageFlags(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pDefender, ESE_D2DamageStrc* pDamage)
{
    ...
    ESE_D2GAME_MONSTER_ApplyCriticalDamage_6FC62E70(pOwner, pDefender, pDamage);
    ...
    {
        ESE_SUNITDMG_ExecuteEvents(pGame, pOwner, pDefender, 1, pDamage);
    }

    ESE_SUNITDMG_ExecuteMissileDamage(pGame, pOwner, pDefender, pDamage);
}
...
//D2Game.0x6FC5F7C0
int32_t __fastcall ESE_MISSMODE_RadamentDeathAreaEffectCallback(D2GameStrc* pGame, D2UnitStrc* pUnit, D2UnitStrc* pCorpse, int32_t nSkillLevel, int32_t nUnused)
{
    return ESE_SKILLS_ApplyRedemptionEffect(pGame, pUnit, pCorpse, SKILL_REDEMPTION, nSkillLevel, 0);
}

//D2Game.0x6FC5F7E0
int32_t __fastcall ESE_MISSMODE_RadamentDeathAreaEffectCallbackFirstFrame(D2GameStrc* pGame, D2UnitStrc* pUnit, D2UnitStrc* pCorpse, int32_t nSkillLevel, int32_t nUnused)
{
    return ESE_SKILLS_ApplyRedemptionEffect(pGame, pUnit, pCorpse, SKILL_REDEMPTION, nSkillLevel, 1);
}

//D2Game.0x6FC5F800
int32_t __fastcall ESE_MISSMODE_SrvDo36_BaalFxControl(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
...
//D2Game.0x6FC5F860
int32_t __fastcall ESE_MISSMODE_SrvHit57_BaalFxControl(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit)
{
    if (!pUnit && !MISSILE_GetTargetX(pMissile))
    {
        MISSILE_SetTargetX(pMissile, 1);
...
//D2Game.0x6FC5F8B0
int32_t __fastcall ESE_MISSMODE_SrvDo37_Unused(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    if (!pMissile)
    {
        return 2;
...
//D2Game.0x6FC5F8C0
int32_t __fastcall ESE_MISSMODE_SrvDo01_BasicMissile(D2GameStrc* pGame, D2UnitStrc* pMissile)
{
    return ESE_MISSMODE_HandleMissileCollision(pGame, pMissile);
}

//D2Game.0x6FC5FAD0
int32_t __fastcall ESE_MISSMODE_SrvDmgHitHandler(D2GameStrc* pGame, D2UnitStrc* pMissile, D2UnitStrc* pUnit, int32_t a4)
{
    using MissileDmgFunc = void(__fastcall*)(D2GameStrc*, D2UnitStrc*, D2UnitStrc*, ESE_D2DamageStrc*);
    constexpr MissileDmgFunc gpMissileSrvDmgFnTable_6FD2E838[] =
    {
        nullptr,
        ESE_MISSMODE_SrvDmg01_FireArrow_MagicArrow_ColdArrow,
        ESE_MISSMODE_SrvDmg02_IceArrow_RoyalStrikeChaos,
        ESE_MISSMODE_SrvDmg03_Blaze_FireWall_ImmolationFire_MeteorFire,
        ESE_MISSMODE_SrvDmg04_IceBlast,
        ESE_MISSMODE_SrvDmg05_BlessedHammer,
        ESE_MISSMODE_SrvDmg06_Unused,
        ESE_MISSMODE_SrvDmg07_Warcry_ShockWave,
        ESE_MISSMODE_SrvDmg08_EruptionCrack,
        ESE_MISSMODE_SrvDmg09_Twister,
        ESE_MISSMODE_SrvDmg10_BladesOfIceCubes,
        ESE_MISSMODE_SrvDmg11_RabiesContagion,
        ESE_MISSMODE_SrvDmg12_LightningJavelin,
        ESE_MISSMODE_SrvDmg13_BlessedHammerEx,
        ESE_MISSMODE_SrvDmg14_MoltenBoulder,
        nullptr,
        nullptr,
        nullptr,
        nullptr,
    ...
    {
        nullptr,
        ESE_MISSMODE_SrvHit01_Fireball_ExplodingArrow_FreezingArrowExplosion,
        ESE_MISSMODE_SrvHit02_PlagueJavelin_PoisonPotion,
        ESE_MISSMODE_SrvHit03_ExplosivePotion_BombOnGround,
        ESE_MISSMODE_SrvHit04_ExplodingArrow_FreezingArrow_RoyalStrikeMeteorCenter,
        ESE_MISSMODE_SrvHit05_Unused,
        ESE_MISSMODE_SrvHit06_Unused,
        ESE_MISSMODE_SrvHit07_HolyBolt_FistOfTheHeavenBolt,
        ESE_MISSMODE_SrvHit08_Blaze,
        ESE_MISSMODE_SrvHit09_ImmolationArrow,
        ESE_MISSMODE_SrvHit10_GuidedArrow_BoneSpirit,
        ESE_MISSMODE_SrvHit11_Unused,
        ESE_MISSMODE_SrvHit12_ChainLightning_LightningStrike,
        ESE_MISSMODE_SrvHit13_GlacialSpike_HellMeteorDown,
        ESE_MISSMODE_SrvHit14_MeteorCenter_CatapultMeteor_RoyalStrikeMeteor,
        ESE_MISSMODE_SrvHit15_SpiderGooLay,
        ESE_MISSMODE_SrvHit16_SpiderGoo_VinesTrail_VinesWither,
        ESE_MISSMODE_SrvHit17_Howl,
        ESE_MISSMODE_SrvHit18_Shout_BattleCommand_BattleOrders,
        ESE_MISSMODE_SrvHit19_FingerMageSpider,
        ESE_MISSMODE_SrvHit20_LightningFury,
        ESE_MISSMODE_SrvHit21_BattleCry,
        ESE_MISSMODE_SrvHit22_FistOfTheHeavensDelay,
        ESE_MISSMODE_SrvHit23_Unused,
        ESE_MISSMODE_SrvHit24_PantherPotOrange,
        ESE_MISSMODE_SrvHit25_PantherPotGreen,
        ESE_MISSMODE_SrvHit26_GrimWardStart,
        ESE_MISSMODE_SrvHit27_GrimWard,
        ESE_MISSMODE_SrvHit28_GrimWardScare,
        ESE_MISSMODE_SrvHit29_FrozenOrb,
        nullptr,
        ESE_MISSMODE_SrvHit31_FireHead,
        ESE_MISSMODE_SrvHit32_CairnStones,
        ESE_MISSMODE_SrvHit33_TowerChestSpawner,
        nullptr,
        ESE_MISSMODE_SrvHit35_OrbMist,
        ESE_MISSMODE_SrvHit36_MissileInAir,
        ESE_MISSMODE_SrvHit37_BladeCreeper,
        ESE_MISSMODE_SrvHit38_CatapultChargedBall,
        ESE_MISSMODE_SrvHit39_ImpSpawnMonsters,
        ESE_MISSMODE_SrvHit40_CatapultSpikeBall,
        nullptr,
        nullptr,
        ESE_MISSMODE_SrvHit43_HealingVortex,
        ESE_MISSMODE_SrvHit44_ExplodingJavelin,
        ESE_MISSMODE_SrvHit45_LightningTrailingJavelin,
        nullptr,
        ESE_MISSMODE_SrvHit47_MoltenBoulder,
        ESE_MISSMODE_SrvHit48_MoltenBoulderEmerge,
        nullptr,
        ESE_MISSMODE_SrvHit50_PlagueVinesTrail,
        ESE_MISSMODE_SrvHit51_VolcanoDebris,
        ESE_MISSMODE_SrvHit52_BladeFury,
        ESE_MISSMODE_SrvHit53_RabiesContagion,
        ESE_MISSMODE_SrvHit54_BaalSpawnMonsters,
        ESE_MISSMODE_SrvHit55_Baalnferno,
        ESE_MISSMODE_SrvHit56_ArmageddonControl,
        ESE_MISSMODE_SrvHit57_BaalFxControl,
        ESE_MISSMODE_SrvHit58_BaalTauntLightningControl,
        ESE_MISSMODE_SrvHit59_BaalTauntPoisonControl,
        nullptr,
        nullptr,
        nullptr,
        nullptr,
    ...
    if (pMissile)
    {
        pMissilesTxtRecord = ESE_SKILLS_GetMissilesTxtRecord(pMissile->dwClassId);
    }
    ...
    if (pUnit)
    {
        if (pMissilesTxtRecord->nToHit)
        {
            ...
            if (!ESE_SUNITDMG_IsHitSuccessful(pOwner, pUnit, nToHit, 1))
            {
                ...
                ESE_SUNITEVENT_EventFunc_Handler(pGame, EVENT_HITBYMISSILE, pUnit, pMissile, nullptr);
    ...
    if (nPierceFlags & 2)
    {
        ...
        ESE_SUNITEVENT_EventFunc_Handler(pGame, EVENT_HITBYMISSILE, pUnit, pMissile, 0);
    ...
    if (pUnit && nHitResult & 2)
    {
        ...
        ESE_MISSMODE_SetDamageFlags(pGame, pMissile, pUnit, &damage);
...
//D2Game.0x6FC60080
void __fastcall ESE_MISSMODE_ToggleStateOff(D2UnitStrc* pUnit, int32_t nState, D2StatListStrc* pStatList)
{
...
//D2Game.0x6FC60090
void __fastcall ESE_MISSMODE_SrvDoHandler(D2GameStrc* pGame, D2UnitStrc* pMissile, int32_t nUnused)
{
    using MissileSrvDoFunc = int32_t(__fastcall*)(D2GameStrc*, D2UnitStrc*);
    constexpr MissileSrvDoFunc gMissileSrvDoFuncTable[] =
    {
        nullptr,
        ESE_MISSMODE_SrvDo01_BasicMissile,
        ESE_MISSMODE_SrvDo02_PlagueJavelin_PoisonJavelin_PoisonTrap,
        ESE_MISSMODE_SrvDo03_PoisonCloud_Blizzard_ThunderStorm_HandOfGod,
        nullptr,
        ESE_MISSMODE_SrvDo05_FireWall_ImmolationFire_MeteorFire_MoltenBoulderFirePath,
        ESE_MISSMODE_SrvDo06_MoltenBoulder_FireWallMaker,
        ESE_MISSMODE_SrvDo07_GuidedArrow_BoneSpirit,
        ESE_MISSMODE_SrvDo08_MonBlizzCenter,
        ESE_MISSMODE_SrvDo09_BatLightningBolt,
        ESE_MISSMODE_SrvDo10_BlizzardCenter,
        ESE_MISSMODE_SrvDo11_FingerMageSpider,
        ESE_MISSMODE_SrvDo12_DiabWallMaker,
        ESE_MISSMODE_SrvDo13_BoneWallMaker,
        ESE_MISSMODE_SrvDo14_GrimWard,
        ESE_MISSMODE_SrvDo15_FrozenOrb,
        ESE_MISSMODE_SrvDo16_FrozenOrbNova,
        ESE_MISSMODE_SrvDo17_CairnStones,
        ESE_MISSMODE_SrvDo18_TowerChestSpawner,
        ESE_MISSMODE_SrvDo19_RadamentDeath,
        ESE_MISSMODE_SrvDo20_BladeCreeper,
        ESE_MISSMODE_SrvDo21_Distraction,
        ESE_MISSMODE_SrvDo22_LightningTrailingJavelin,
        ESE_MISSMODE_SrvDo23_24_SuccFireBall_FirestormMaker,
        ESE_MISSMODE_SrvDo23_24_SuccFireBall_FirestormMaker,
        ESE_MISSMODE_SrvDo25_EruptionCenter,
        ESE_MISSMODE_SrvDo26_Vines_PlagueVines,
        ESE_MISSMODE_SrvDo27_Tornado,
        ESE_MISSMODE_SrvDo28_Volcano,
        ESE_MISSMODE_SrvDo29_RecyclerDelay,
        ESE_MISSMODE_SrvDo30_RabiesPlague,
        ESE_MISSMODE_SrvDo31_WakeOfDestructionMaker_BaalColdMaker,
        ESE_MISSMODE_SrvDo32_TigerFury,
        ESE_MISSMODE_SrvDo33_VineRecyclerDelay,
        ESE_MISSMODE_SrvDo34_BaalTauntControl,
        ESE_MISSMODE_SrvDo35_RoyalStrikeChaosIce,
        ESE_MISSMODE_SrvDo36_BaalFxControl,
        ESE_MISSMODE_SrvDo37_Unused,
        nullptr,
        nullptr,
        nullptr,
        nullptr,
