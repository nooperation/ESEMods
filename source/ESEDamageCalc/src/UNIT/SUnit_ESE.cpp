...
// TODO: This probably needs to point to the original memory location so seeding is not impacted?
int32_t ESE_dword_6FD4DC40;
...
void __fastcall ESE_SUNIT_InitSeed(D2UnitStrc* pUnit, D2SeedStrc* pSeed)
{
    ...
    {
        pUnit->dwInitSeed = SEED_GetRandomValue(2 * ESE_dword_6FD4DC40);
        ++ESE_dword_6FD4DC40;
    }
...
//D2Game.0x6FCBDC60
int32_t __fastcall ESE_SUNIT_AreUnitsAligned(D2GameStrc* pGame, D2UnitStrc* pUnit1, D2UnitStrc* pUnit2)
{
