...
decltype(&SKILLS_SrvSt22_PsychicHammer) SKILLS_SrvSt22_PsychicHammer_Original = nullptr;
decltype(&SKILLS_SrvDo033_PsychicHammer) SKILLS_SrvDo033_PsychicHammer_Original = nullptr;
decltype(&SKILLS_SrvSt23_AssasinChargeStrikes) SKILLS_SrvSt23_AssasinChargeStrikes_Original = nullptr;
decltype(&SKILLS_StatRemoveCallback_ProgressiveStrike) SKILLS_StatRemoveCallback_ProgressiveStrike_Original = nullptr;
decltype(&SKILLS_SrvDo034_TigerStrike_CobraStrike_RoyalStrike) SKILLS_SrvDo034_TigerStrike_CobraStrike_RoyalStrike_Original = nullptr;
decltype(&SKILLS_SrvDo035_FistsOfFire_ClawsOfThunder_BladesOfIce) SKILLS_SrvDo035_FistsOfFire_ClawsOfThunder_BladesOfIce_Original = nullptr;
decltype(&sub_6FCF5680) sub_6FCF5680_Original = nullptr;
decltype(&sub_6FCF5870) sub_6FCF5870_Original = nullptr;
decltype(&SKILLS_GetSkillsTxtRecord) SKILLS_GetSkillsTxtRecord_Original = nullptr;
decltype(&sub_6FCF5BC0) sub_6FCF5BC0_Original = nullptr;
decltype(&sub_6FCF5DE0) sub_6FCF5DE0_Original = nullptr;
decltype(&SKILLS_GetProgressiveSkillMissileId) SKILLS_GetProgressiveSkillMissileId_Original = nullptr;
decltype(&SKILLS_EvaluateProgressiveSkillCalc) SKILLS_EvaluateProgressiveSkillCalc_Original = nullptr;
decltype(&SKILLS_SrvDo038_FistsOfFire_BladesOfIce_ProgressiveFn2) SKILLS_SrvDo038_FistsOfFire_BladesOfIce_ProgressiveFn2_Original = nullptr;
decltype(&SKILLS_SrvDo039_FistsOfFire_BladesOfIce_ProgressiveFn3) SKILLS_SrvDo039_FistsOfFire_BladesOfIce_ProgressiveFn3_Original = nullptr;
decltype(&SKILLS_SrvDo036_ClawsOfThunder_ProgressiveFn2) SKILLS_SrvDo036_ClawsOfThunder_ProgressiveFn2_Original = nullptr;
decltype(&SKILLS_SrvDo037_ClawsOfThunder_ProgressiveFn3) SKILLS_SrvDo037_ClawsOfThunder_ProgressiveFn3_Original = nullptr;
decltype(&sub_6FCF6600) sub_6FCF6600_Original = nullptr;
decltype(&sub_6FCF6C10) sub_6FCF6C10_Original = nullptr;
decltype(&SKILLS_SrvDo143_FistsOfFire_RoyalStrike_ProgressiveFn) SKILLS_SrvDo143_FistsOfFire_RoyalStrike_ProgressiveFn_Original = nullptr;
decltype(&sub_6FCF6D70) sub_6FCF6D70_Original = nullptr;
decltype(&sub_6FCF7390) sub_6FCF7390_Original = nullptr;
decltype(&SKILLS_SrvDo040_RoyalStrike_ProgressiveFn1) SKILLS_SrvDo040_RoyalStrike_ProgressiveFn1_Original = nullptr;
decltype(&SKILLS_SrvDo041_RoyalStrike_ProgressiveFn3) SKILLS_SrvDo041_RoyalStrike_ProgressiveFn3_Original = nullptr;
decltype(&sub_6FCF77E0) sub_6FCF77E0_Original = nullptr;
decltype(&SKILLS_SrvSt24_DragonTalon) SKILLS_SrvSt24_DragonTalon_Original = nullptr;
decltype(&sub_6FCF7BC0) sub_6FCF7BC0_Original = nullptr;
decltype(&sub_6FCF7CE0) sub_6FCF7CE0_Original = nullptr;
decltype(&SKILLS_SrvDo042_DragonTalon) SKILLS_SrvDo042_DragonTalon_Original = nullptr;
decltype(&sub_6FCF8330) sub_6FCF8330_Original = nullptr;
decltype(&SKILLS_SrvDo043_ShockField) SKILLS_SrvDo043_ShockField_Original = nullptr;
decltype(&sub_6FCF8610) sub_6FCF8610_Original = nullptr;
decltype(&SKILLS_SrvDo044_BladeSentinel) SKILLS_SrvDo044_BladeSentinel_Original = nullptr;
decltype(&SKILLS_SrvDo045_Sentry) SKILLS_SrvDo045_Sentry_Original = nullptr;
decltype(&SKILLS_SrvDo046_DragonClaw) SKILLS_SrvDo046_DragonClaw_Original = nullptr;
decltype(&sub_6FCF8C70) sub_6FCF8C70_Original = nullptr;
decltype(&sub_6FCF8DD0) sub_6FCF8DD0_Original = nullptr;
decltype(&SKILLS_SrvDo047_CloakOfShadows) SKILLS_SrvDo047_CloakOfShadows_Original = nullptr;
decltype(&SKILLS_AuraCallback_CloakOfShadows) SKILLS_AuraCallback_CloakOfShadows_Original = nullptr;
decltype(&SKILLS_SrvDo048_BladeFury) SKILLS_SrvDo048_BladeFury_Original = nullptr;
decltype(&SKILLS_SrvSt26_BladeFury) SKILLS_SrvSt26_BladeFury_Original = nullptr;
decltype(&SKILLS_StatRemoveCallback_RemoveState) SKILLS_StatRemoveCallback_RemoveState_Original = nullptr;
decltype(&sub_6FCF9580) sub_6FCF9580_Original = nullptr;
decltype(&SKILLS_SrvDo049_ShadowWarrior_Master) SKILLS_SrvDo049_ShadowWarrior_Master_Original = nullptr;
decltype(&SKILLS_SrvSt27_DragonTail) SKILLS_SrvSt27_DragonTail_Original = nullptr;
decltype(&SKILLS_SrvDo050_DragonTail) SKILLS_SrvDo050_DragonTail_Original = nullptr;
decltype(&SKILLS_StatRemoveCallback_MindBlast) SKILLS_StatRemoveCallback_MindBlast_Original = nullptr;
decltype(&SKILLS_AuraCallback_MindBlast) SKILLS_AuraCallback_MindBlast_Original = nullptr;
decltype(&SKILLS_SrvDo051_MindBlast) SKILLS_SrvDo051_MindBlast_Original = nullptr;
decltype(&SKILLS_SrvDo052_DragonFlight) SKILLS_SrvDo052_DragonFlight_Original = nullptr;
decltype(&SKILLS_SrvSt28_BladeShield) SKILLS_SrvSt28_BladeShield_Original = nullptr;
decltype(&SKILLS_SrvDo053_Unused) SKILLS_SrvDo053_Unused_Original = nullptr;
decltype(&SKILLS_AuraCallback_SrvDo142) SKILLS_AuraCallback_SrvDo142_Original = nullptr;
decltype(&SKILLS_SrvDo142_Unused) SKILLS_SrvDo142_Unused_Original = nullptr;
decltype(&SKILLS_SrvDo054_BladeShield) SKILLS_SrvDo054_BladeShield_Original = nullptr;
