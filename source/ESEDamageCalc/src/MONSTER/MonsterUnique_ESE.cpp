...
//D2Game.0x6FC6AC00
void __fastcall ESE_MONSTERUNIQUE_ToggleUnitFlag(D2UnitStrc* pUnit, int32_t nFlag, int32_t bSet)
{
    if (!pUnit)
    {
        return;
...
//D2Game.0x6FC6AC30
uint8_t* __fastcall ESE_MONSTERUNIQUE_GetUMods(D2UnitStrc* pUnit)
{
...
//D2Game.0x6FC6AC50
uint16_t __fastcall ESE_MONSTERUNIQUE_GetNameSeed(D2UnitStrc* pUnit)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER && pUnit->pMonsterData)
    {
...
//D2Game.0x6FC6AC70
int32_t __fastcall ESE_MONSTERUNIQUE_CheckMonTypeFlag(D2UnitStrc* pUnit, uint16_t nFlag)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER && pUnit->pMonsterData)
    {
...
//D2Game.0x6FC6ACA0
void __fastcall ESE_MONSTERUNIQUE_ToggleMonTypeFlag(D2UnitStrc* pUnit, uint16_t nFlag, int32_t bSet)
{
    if (!pUnit || pUnit->dwUnitType != UNIT_MONSTER || !pUnit->pMonsterData)
    {
        return;
...
//D2Game.0x6FC6ACD0
int16_t __fastcall ESE_MONSTERUNIQUE_GetBossHcIdx(D2UnitStrc* pUnit)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER && pUnit->pMonsterData)
    {
...
//D2Game.0x6FC6ACF0
int32_t __fastcall ESE_MONSTERUNIQUE_HasUMods(D2UnitStrc* pUnit)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER && pUnit->pMonsterData)
    {
...
//D2Game.0x6FC6AD10
int32_t __fastcall ESE_MONSTERUNIQUE_GetSuperUniqueBossHcIdx(D2GameStrc* pGame, D2UnitStrc* pUnit)
{
...
//D2Game.0x6FC6AD50
void __fastcall ESE_MONSTERUNIQUE_UMod1_RandomName(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6AD90
void __fastcall ESE_MONSTERUNIQUE_UMod2_HealthBonus(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6AFF0
void __fastcall ESE_MONSTERUNIQUE_UMod4_LevelBonus(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER)
    {
...
//D2Game.0x6FC6B3A0
void __fastcall ESE_MONSTERUNIQUE_UMod37_Fanatic(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6B3E0
void __fastcall ESE_MONSTERUNIQUE_UMod38_Possessed(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit || pUnit->dwUnitType != UNIT_MONSTER || !bUnique)
    {
        return;
...
//D2Game.0x6FC6B5D0
void __fastcall ESE_MONSTERUNIQUE_UMod41_AlwaysRun(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6B8C0
void __fastcall ESE_MONSTERUNIQUE_UMod26_Teleport(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER && bUnique)
    {
...
//D2Game.0x6FC6B910
void __fastcall ESE_MONSTERUNIQUE_UMod30_AuraEnchanted(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6BB80
void __fastcall ESE_MONSTERUNIQUE_UMod6_Fast(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit || pUnit->dwUnitType != UNIT_MONSTER)
    {
        return;
...
//D2Game.0x6FC6C4F0
void __fastcall ESE_MONSTERUNIQUE_CastAmplifyDamage(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t a3, int32_t a4)
{
...
//D2Game.0x6FC6C5B0
void __fastcall ESE_MONSTERUNIQUE_CurseCallback_ApplyAmplifyDamage(D2GameStrc* pGame, D2UnitStrc* pUnit, D2UnitStrc* pTarget, int32_t nSkillLevel)
{
...
//D2Game.0x6FC6C710
void __fastcall ESE_MONSTERUNIQUE_FireEnchantedModeChange(D2GameStrc* pGame, D2UnitStrc* pBoss, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6CAB0
void __fastcall ESE_MONSTERUNIQUE_CastNova(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!bUnique)
    {
        return;
...
//D2Game.0x6FC6CB40
void __fastcall ESE_MONSTERUNIQUE_CastLightUniqueMissile(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!bUnique)
    {
        return;
...
//D2Game.0x6FC6CD30
void __fastcall ESE_sub_6FC6CD30(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6CD60
void __fastcall ESE_MONSTERUNIQUE_CastColdUniqueMissile(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!bUnique)
    {
        return;
...
//D2Game.0x6FC6CE50
void __fastcall ESE_MONSTERUNIQUE_KillMinions(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6CEC0
void __fastcall ESE_MONSTERUNIQUE_MinionCallback_KillMinion(D2UnitStrc* pUnit, void* pGameArg, void* pUnused)
{
...
//D2Game.0x6FC6D030
void __fastcall ESE_MONSTERUNIQUE_ScarabModeChange(D2GameStrc* pGame, D2UnitStrc* pBoss, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6D060
void __fastcall ESE_MONSTERUNIQUE_CastBugLightningMissile(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    D2MissileStrc missileParams = {};
...
//D2Game.0x6FC6D410
D2MonUModTxt* __fastcall ESE_MONSTERUNIQUE_GetMonUModTxtRecord(uint32_t nUMod)
{
...
//D2Game.0x6FC6D440
void __fastcall ESE_sub_6FC6D440(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MISSILE)
    {
...
//D2Game.0x6FC6D690
void __fastcall ESE_MONSTERUNIQUE_StealBeltItem(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!bUnique)
    {
        return;
...
//D2Game.0x6FC6D800
void __fastcall ESE_MONSTERUNIQUE_QuestCompleteModeChange(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit)
    {
        return;
...
//D2Game.0x6FC6D8B0
void __fastcall ESE_MONSTERUNIQUE_CastQueenPoisonCloudMissile(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    D2MissileStrc missileParams = {};
    missileParams.dwFlags = 0x21;
    missileParams.pOwner = pUnit;
...
//D2Game.0x6FC6DA40
void __fastcall ESE_sub_6FC6DA40(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6DCB0
void __fastcall ESE_MONSTERUNIQUE_LightningEnchantedModeChange(D2GameStrc* pGame, D2UnitStrc* pBoss, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6DCE0
void __fastcall ESE_MONSTERUNIQUE_ColdEnchantedModeChange(D2GameStrc* pGame, D2UnitStrc* pBoss, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6DD20
void __fastcall ESE_sub_6FC6DD20(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit)
    {
        return;
...
//D2Game.0x6FC6DDE0
void __fastcall ESE_sub_6FC6DDE0(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit)
    {
        return;
...
//D2Game.0x6FC6DFA0
void __fastcall ESE_MONSTERUNIQUE_ApplyShatterState(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit || pUnit->dwAnimMode == MONMODE_DEATH)
    {
...
//D2Game.0x6FC6DFC0
void __fastcall ESE_sub_6FC6DFC0(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6E070
void __fastcall ESE_MONSTERUNIQUE_SetTrapDamage(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    int32_t nLevel = 2;
...
//D2Game.0x6FC6E390
void __fastcall ESE_MONSTERUNIQUE_SuicideModeChange(D2GameStrc* pGame, D2UnitStrc* pBoss, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6E700
void __fastcall ESE_MONSTERUNIQUE_CreatePainWorm(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (!pUnit || pUnit->dwAnimMode == MONMODE_DEATH)
    {
...
//D2Game.0x6FC6E730
void __fastcall ESE_sub_6FC6E730(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    if (SUNIT_IsDead(pUnit))
    {
        return;
...
//D2Game.0x6FC6E770
void __fastcall ESE_sub_6FC6E770(D2GameStrc* pGame, D2UnitStrc* pUnit)
{
    sub_6FC6E780(pGame, pUnit, 0, 0);
}

//D2Game.0x6FC6E780
void __fastcall ESE_sub_6FC6E780(D2GameStrc* pGame, D2UnitStrc* pUnit, D2UnitStrc* pMissile, int32_t nIndex)
{
...
//D2Game.0x6FC6E860
void __fastcall ESE_sub_6FC6E860(D2GameStrc* pGame, D2UnitStrc* pUnit)
{
    sub_6FC6E780(pGame, pUnit, 0, 1);
}

//D2Game.0x6FC6E870
void __fastcall ESE_D2GAME_MONSTERS_AiFunction08_6FC6E870(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
    sub_6FC6E780(pGame, pUnit, 0, 2);
}

//D2Game.0x6FC6E890
void __fastcall ESE_sub_6FC6E890(D2GameStrc* pGame, D2UnitStrc* pUnit)
{
    sub_6FC6E780(pGame, pUnit, 0, 3);
}

//D2Game.0x6FC6E8A0
void __fastcall ESE_sub_6FC6E8A0(D2GameStrc* pGame, D2UnitStrc* pUnit)
{
    sub_6FC6E780(pGame, pUnit, 0, 4);
}

//D2Game.0x6FC6E8B0
void __fastcall ESE_sub_6FC6E8B0(D2GameStrc* pGame, D2UnitStrc* pUnit, D2UnitStrc* pMissile)
{
...
//D2Game.0x6FC6E8D0
D2UnitStrc* __fastcall ESE_sub_6FC6E8D0(D2GameStrc* pGame, D2ActiveRoomStrc* pRoom, D2RoomCoordListStrc* pRoomCoordList, int32_t nSuperUniqueId, int32_t a5, uint16_t nX, uint16_t nY, int32_t a8)
{
...
//D2Game.0x6FC6E940
void __fastcall ESE_sub_6FC6E940(D2GameStrc* pGame, D2UnitStrc* pUnit, int32_t a3)
{
...
//D2Game.0x6FC6EBE0
D2MonsterDataStrc* __fastcall ESE_MONSTERUNIQUE_GetMonsterData(D2UnitStrc* pUnit)
{
    if (pUnit && pUnit->dwUnitType == UNIT_MONSTER)
    {
...
//D2Game.0x6FC6EBF0
int32_t __fastcall ESE_MONSTERUNIQUE_GetUModCount(uint8_t* pUMods)
{
    int32_t nIndex = 0;
...
//D2Game.0x6FC6EC10
int32_t __fastcall ESE_sub_6FC6EC10(D2UnitStrc* pUnit, D2MonUModTxt* pMonUModTxtRecord, int32_t bExpansion)
{
...
//D2Game.0x6FC6EE90
int32_t __fastcall ESE_sub_6FC6EE90(D2GameStrc* pGame, D2UnitStrc* pUnit, uint8_t* a3)
{
    if (!pGame || pGame->nDifficulty >= 3u)
    {
        return 0;
...
//D2Game.0x6FC6F160
uint32_t __fastcall ESE_MONSTERUNIQUE_CheckMonModeFlag(int32_t nMonsterId, int32_t nFlag)
{
...
//D2Game.0x6FC6F1D0
uint32_t __fastcall ESE_MONSTERUNIQUE_CheckMonStatsFlag(int32_t nMonsterId, int32_t nFlag)
{
...
//D2Game.0x6FC6F220
D2UnitStrc* __fastcall ESE_D2GAME_SpawnMonster_6FC6F220(D2GameStrc* pGame, D2ActiveRoomStrc* pRoom, D2RoomCoordListStrc* pRoomCoordList, int32_t nX, int32_t nY, int32_t nUnitGUID, int32_t nClassId, int32_t a8)
{
    if (!nX && !nY)
    {
...
//D2Game.0x6FC6F440
void __fastcall ESE_D2GAME_SpawnMinions_6FC6F440(D2GameStrc* pGame, D2ActiveRoomStrc* pRoom, D2RoomCoordListStrc* pRoomCoordList, D2UnitStrc* pUnit, int32_t bSpawnMinions, int32_t nMinGroup, int32_t nMaxGroup)
{
    if (bSpawnMinions)
    {
...
//D2Game.0x6FC6F670
void __fastcall ESE_sub_6FC6F670(D2UnitStrc* pUnit, int32_t nUMod, int32_t bUnique)
{
...
//D2Game.0x6FC6F690
D2UnitStrc* __fastcall ESE_D2GAME_SpawnSuperUnique_6FC6F690(D2GameStrc* pGame, D2ActiveRoomStrc* pRoom, int32_t nX, int32_t nY, int32_t nSuperUnique)
{
...
//D2Game.0x6FC6FDC0
D2UnitStrc* __fastcall ESE_sub_6FC6FDC0(D2GameStrc* pGame, D2ActiveRoomStrc* pRoom, int32_t nX, int32_t nY, int32_t nClassId, int32_t nUnitGUID, uint8_t* pUMods)
{
...
//D2Game.0x6FC6FFD0
void __fastcall ESE_D2GAME_MONSTERS_Unk_6FC6FFD0(D2GameStrc* pGame, D2UnitStrc* pUnit, uint8_t nUMod)
{
    if (!pUnit || pUnit->dwUnitType != UNIT_MONSTER)
    {
        return;
