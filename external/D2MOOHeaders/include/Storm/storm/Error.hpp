...
D2FUNC_DLL_NP(STORM, SErrDisplayErrorFmt, int32_t, __cdecl, (uint32_t messageId, const char* filename, int32_t linenumber, int32_t recoverable, uint32_t uExitCode, const char* Format, ...), 0x12570);     //Storm.#562
